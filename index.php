...
<head>
    ...
    <title>Planet Shopify | Online Shopping </title>
...
<body style="margin-bottom:200px">
        ...
        <div id="bg" class=" ">
            <div class="container" style="padding-top:150px">
                <div class="mx-auto p-5 text-white" id="banner_content" style="border-radius: 0.5rem;">
                    <marquee>
                        <h1>โปรโมชั่นประจำเดือนสิงหาคม</h1>
                        <p>พบกับสินค้าลด 99 % </p>
                        <a href="products.php" class="btn btn-warning btn-lg text-white">ช็อปเลย</a>
                    </marquee>
    ...
    <div class="text-center pt-4 h3">
        <marquee> * สินค้าที่ทันสมัย *</marquee>
    </div>
